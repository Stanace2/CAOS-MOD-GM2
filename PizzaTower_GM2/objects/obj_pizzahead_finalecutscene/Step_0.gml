	...
	case states.jump:
		...
		if (ANIMATION_END)
		{
			...
			if (image_xscale > 0)
			{
				...
				{
					case spr_beatdown1:
						sprite_index = spr_beatdown2;
						break;
					case spr_beatdown2:
						sprite_index = spr_beatdown3;
						break;
					case spr_beatdown3:
						sprite_index = spr_beatdown4;
						break;
					case spr_beatdown4:
						sprite_index = spr_beatdown5;
						break;
					case spr_beatdown5:
						sprite_index = spr_beatdown6;
						break;
					case spr_beatdown6:
						sprite_index = spr_beatdown7;
						break;
					case spr_beatdown7:
						sprite_index = spr_beatdown8;
						break;
					case spr_beatdown8:
						sprite_index = spr_beatdown9;
						break;
					case spr_beatdown9:
						sprite_index = spr_beatdown10;
						break;
					case spr_beatdown10:
						sprite_index = spr_beatdown11;
						break;
					case spr_beatdown11:
						sprite_index = spr_beatdown12;
						break;
					case spr_beatdown12:
						sprite_index = spr_beatdown13;
						break;
					case spr_beatdown13:
						sprite_index = spr_beatdown14;
						break;
					case spr_beatdown14:
						sprite_index = spr_beatdown15;
						break;
					case spr_beatdown15:
						sprite_index = spr_beatdown14;
						image_xscale = -1;
