...
var _inv = (state == states.stun && savedthrown == thrown && !savedthrown) || (obj_player1.characterID == characters.dos) || (!obj_player1.ispeppino && state == states.ram && substate == states.land);
if (_inv && elitehit > 1)
{
	invincible = false;
}
