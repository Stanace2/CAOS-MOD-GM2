if ((sprite_index == spr_horsey_win || sprite_index == spr_horsey_lose) && (!other.ispeppino || obj_player1.characterID == characters.noise) && (other.instakillmove == true || other.state == states.handstandjump || other.state == states.mach2))
{
	var t = other.id;
