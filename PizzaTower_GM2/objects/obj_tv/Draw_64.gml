...
pal_swap_set(spr_tv_combopalette, (obj_player1.ispeppino && obj_player1.characterID != characters.noise && !global.swapmode) ? 0 : 1, false);
...
if (room != strongcold_endscreen)
{
	...
	var _red = global.noisejetpack && ((obj_player1.ispeppino && obj_player1.characterID != characters.noise) || obj_player1.noisepizzapepper);
	if (_red)
	{
