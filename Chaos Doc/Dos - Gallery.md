...
spr_knightpep_start | *50 100*
spr_knightpep_thunder | *50 100*
spr_knightpep_doublejump | *50 100*
spr_player_keyget | *50 100*
spr_player_gnomecutscene3 | *50 100*
spr_player_gnomecutscene4 | *50 100*
spr_player_screamtransition | *50 100*
spr_player_levelcomplete | *50 100*
spr_vspeppino | *0 657*
spr_vspeppinoshadow | *0 657*
spr_player_firemouth | *100 50*
spr_player_firemouthintro | *50 100*
spr_player_firemouthidle | *50 100*
spr_player_mortjump | *50 100*
spr_player_weeniemount | *50 100*
spr_player_weenieturn | *50 100*
spr_player_poweredup | *50 100*
spr_player_jetpackmid | *50 100*
spr_player_jetpackend | *50 100*
spr_player_shotgun | *50 100* ==shotgun_shot, changed y axis==
spr_player_shotgunjump1 | *50 100*
spr_player_shotgunjump3 | *50 100*
spr_player_bodyslamfall | *50 100*
spr_player_bodyslamstart | *50 100*
spr_player_firemouthend | *50 100*
spr_pepdance | *50 100*
spr_towerintro_peppino | *80 201*
spr_towerintro_gustavo | *68 173*
spr_pepbossintro3 | *50 100*
spr_towerending_peppino | *50 100*
spr_towerending_gustavo | *50 100*
### Addons
#### Last hours (After V1)
spr_player_snapcut | *50 50* ==Unused, could add this one as an uppercut after a snapjump==
spr_dos_unhingedrun | *150 50*
spr_dos_walllaunch | *50 61*
spr_player_snapcrouch | *75 50*
spr_player_snapcrouch_loop | *75 50*
#### Oldies
spr_player_dressup | *50 50*
spr_player_snapnailit | *100 100*
...
##### for the alt pep grab dash | seen in pizzaface pt3 or with pizza pepper (only on moveset swap)
spr_player_suplexdashALT | *50 50*
spr_player_suplexgrabjumpstartALT | *50 50*
spr_player_suplexgrabjumpALT | *50 50*
spr_player_longjumpALT | *75 70*
spr_player_longjumpendALT | *75 75*
##### addon | anims for fakepep fight and -Don't make a sound-
spr_donisha_scared | *50 50*
##### addon | donisha has an alternate version for "mach3" when getting up
spr_player_rollgetupALT | *50 50*
##### addon | scr_characterspr()
spr_player_idlephone | *50 50*
##### When donisha scarely screams at the start of boss battles
spr_player_screamstartnerves | *50 100*
spr_player_screamnerves | *50 100*
spr_player_screamnervestransition | *50 100*
spr_player_intronerves | *50 50*
##### Mort: Create var global.friendShip, Make conditional in scr_player_mort, replace variables in all mort instances, place reset var in scr_playerrest
spr_player_mortattackfrontD | *130 138*
spr_player_mortdoublejumpD | *130 138*
spr_player_mortjumpD | *75 97*
spr_player_mortidleD | *75 97*
spr_player_mortjumpstartD | *75 97*
spr_player_mortlandD | *75 97*
spr_player_mortwalkD | *75 97*
##### Flipped: obj_exitgustavo (subject to change)
spr_gustavo_exit_flipped | *60 53*
spr_stick_exit_flipped | *65 60*
##### addon | scr_player_normal. Donisha doesnt like the noise
spr_player_judge | *50 50*
##### addon, added in noise battle, noise boss obj has the controller i think, end secuence also has it
spr_player_wonder | *60 50*
##### changed image speed
obj_barrel
~~~js
image_speed = 0.35
~~~
##### Tv addons - basically, just dont forget the configuration
[[New tv screens]]
- all *139 134*
spr_tv_exprcollect2 | 
spr_tv_exprhurted |
...
##### Combo bar
[[CB - code changes]]
spr_tv_combobubble_chaosless | *119 91*
spr_tv_combobubblefill_chaosless | *44 51*
spr_tv_combobubbletext_chaosless | *0 0*
##### Addon for final battle, so pizzaface doesnt launch mango (probably obsolete)
spr_reallonebrick_hurt
spr_reallonebrick_roll
#### Chaos power ups
spr_dos_flamecharge | *50 50*
spr_dos_flamedash3 | *100 100*
spr_dos_dragonsnap_prep | *50 50*
spr_dos_dragonsnap | *50 50*
#### Easter eggs
spr_player_machdrift_cancel
spr_player_snapcrouch_air
spr_player_rockget
spr_heavyrock
spr_lightrock
spr_mrded
...
spr_mrscared
### Changes
##### code change | idle anims shouldn't execute while this idle sprite is playing
spr_player_freezeridle
spr_player_snapnailit
## scr_spr_dos()
List of sprites inside variables in scr_spr_dos()
Referenced in:
- [[Sprite initializer and changes]]
~~~js
// All of these sprites will have to be modified; in the future will try to implement peppino, this is mainly for reference at which sprites are escential
...
    spr_idle1 = spr_player_idlephone  
